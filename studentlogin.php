...
<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT name,rollno FROM stu_register WHERE email = '$myusername' and password = '$mypassword'";
  ...
  <body>
    ...
    <form method="post">
        ...
        <div class="form-group">
            ...
            <input type="email" class="form-control" id="Email1" aria-describedby="emailHelp" required name="email">
        </div>
        <div class="form-group">
